...
class SharesController < ApplicationController
  before_action :user_signed_in?, only: %i[destroy create edit]
  before_action :find_post, only: %i[new create edit]
  before_action :find_share, only: %i[new update destroy edit]
